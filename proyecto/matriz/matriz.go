...
func (m *Matriz) Insertar(producto Tienda, x int, y int) {
...
func (m *Matriz)NoExiste(producto Tienda, x int, y int) {
...
func (m *Matriz) ExisteVertical(producto Tienda, x int, y int) {
	m.list_H.Insertar(x) //insertamos en la lista que emula la cabecera horizontal
	m.list_V.Insertar(y) //insertamos en la lista que emula la cabecera vertical
	h:=m.list_H.Buscar(x)//buscamos el nodo que acabamos de incertar para poder enlazar
	v:=m.list_V.Buscar(y)
...
func (m *Matriz) ExisteHorizontal(producto Tienda, x int, y int) {
	m.list_H.Insertar(x) //insertamos en la lista que emula la cabecera horizontal
	m.list_V.Insertar(y) //insertamos en la lista que emula la cabecera vertical
	h:=m.list_H.Buscar(x)//buscamos el nodo que acabamos de incertar para poder enlazar
	v:=m.list_V.Buscar(y)
